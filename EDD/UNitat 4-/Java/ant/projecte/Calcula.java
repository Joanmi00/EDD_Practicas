...
public class Calcula {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("La mitja entre "+operand1+" i "+operand2+" és "+myCalc.media(operand1, operand2));
        System.out.println("El numero mes alt entre "+operand1+" i "+operand2+" és "+myCalc.major(operand1, operand2));
